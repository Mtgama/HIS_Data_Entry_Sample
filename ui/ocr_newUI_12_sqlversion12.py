...
class LoginDialog(QDialog):
    def __init__(self):
        ...
        # Check if the default username and password exist in the database
        self.check_default_credentials()

    def check_default_credentials(self):
        try:
            # Connect to the SQLite database
            conn = sqlite3.connect('datapass.db')
            cursor = conn.cursor()
            
            # Query the database for the default username and password
            cursor.execute("SELECT * FROM users WHERE username = 'admin'")
            result = cursor.fetchone()
            
            # If the default credentials don't exist, insert them into the database
            if not result:
    ...
    def check_login(self):
        ...
        try:
            ...
            self.i += 1
            if self.i == 3:
                QMessageBox.warning(self, 'Too Many Attempts', "Too many login attempts.")
                self.reject()
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:/Users/techp/Downloads/text-recognising.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:/Users/techp/Downloads/kisspng-computer-icons-prettygirl-finder-wedding-air-hor-not-allowed-5aeca6e354ef56.2381821615254586593479.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("C:/Users/techp/Downloads/kisspng-computer-icons-microphone-icon-design-5afc336be510b8.5558613315264776759383.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("C:/Users/techp/Downloads/kisspng-plus-and-minus-signs-computer-icons-clip-art-plus-sign-5aaad857361cb2.9687832115211459432217.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("C:/Users/techp/Downloads/kisspng-microsoft-excel-logo-microsoft-word-microsoft-offi-excel-png-office-xlsx-icon-5ab06a0a133e36.9738910015215109220788.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("C:/Users/techp/Downloads/kisspng-computer-icons-button-send-email-button-5ac4bc896d9823.4635189215228427614489.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("C:/Users/techp/Downloads/kisspng-paper-drawing-pin-clip-art-red-push-pin-5aaaab6c6aea18.5455399415211344444379.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.gridLayout_8.addWidget(self.pushButton_13, 6, 0, 1, 1)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_11.setText(_translate("Form", "حذف نام کاربری "))
        ...
        self.pushButton_13.setText(_translate("Form", "نمایش اطلاعات"))
        ...
        self.checkBox.stateChanged.connect(self.darkmode)
